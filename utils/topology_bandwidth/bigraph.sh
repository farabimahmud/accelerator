...
do
    ...
    do
        ...
        do
            ...
            jobname=${nodes}nodes_${datasize}kB_${element_size}elementsize_${booksim_net}_hdrm
            batchfile=$batch_dir/$jobname\_batch.sh
            ...
            --only-allreduce \\
            --synthetic-data-size $num_elements \\
            > $outdir/${nodes}nodes_${datasize}kB_${element_size}elementsize_hdrm_error.log 2>&1 &" >> $batchfile
