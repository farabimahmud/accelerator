...
def get_slurm_arguments(args):
    ...
    slurm_outpath = '{}/results/weak_scalability_logs/{}nodes_{}data_{}_error.log'.format(os.environ['SIMHOME'], args.nodes, args.data, args.scheme)
...
args.data))
    ...
    program_arguments.append('--outdir={}/results/weak_scalability_logs'.format(os.environ['SIMHOME']))
...
def main():
    ...
    for dimension in range(12, 16, 2):
